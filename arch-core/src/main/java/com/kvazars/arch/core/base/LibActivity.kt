...
abstract class LibActivity<VM : LibViewModel> : AppCompatActivity(), ViewModelBinder {

    lateinit var viewDelegate: ViewDelegate<VM>

    protected val vm: VM by lazy(LazyThreadSafetyMode.NONE) { viewDelegate.viewModel }

//    override val isIdle: Observable<Boolean>
//        get() = viewDelegate.isIdle

    override fun Disposable.untilUnbind() {
        viewDelegate.untilDestroy(this)
    }
