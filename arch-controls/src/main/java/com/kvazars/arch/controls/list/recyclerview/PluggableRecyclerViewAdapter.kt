...
class PluggableRecyclerViewAdapter<T, VH : RecyclerView.ViewHolder>(
    val createViewHolderDelegate: (layoutInflater: LayoutInflater, parent: ViewGroup, viewType: Int) -> VH,
    val bindViewHolderDelegate: (viewHolder: VH, item: T, position: Int) -> Unit,
    areItemsTheSame: (oldItem: T, newItem: T) -> Boolean = { o, n -> o === n },
    areContentsTheSame: (oldItem: T, newItem: T) -> Boolean = { o, n -> Objects.equals(o, n) }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        return createViewHolderDelegate(layoutInflater!!, parent, viewType)
    }

    override fun onBindViewHolder(holder: VH, position: Int) {
        bindViewHolderDelegate(holder, getItem(position), position)
    }
